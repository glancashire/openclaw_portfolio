...
## Period
- Report type: weekly
- Period start: 2026-07-03
- Period end: 2026-07-03
- Generated: 2026-07-03T17:20:16.173Z

## Decision View

### Executive Summary
Latest snapshot: CHF 153951.46955401998 total and CHF 150000 cash. No in-flight execution states are currently pending. Dashboard freshness is current against the tracked source files. Broker readiness is degraded: Interactive Brokers is not ready; broker-backed pricing falls back to draft assumptions. Detail: connect ECONNREFUSED 127.0.0.1:4001 Rendering required a fallback: render mode rendered Reporting delivery posture needs operator attention (1 pending item(s)).
...
- Portfolio value change since previous report: CHF 153951.47
...
| Metric | Value |
|---|---:|
| Start value CHF | 153951.46955401998 |
| End value CHF | 153951.46955401998 |
| Change CHF | 0 |
| Change % | 0 |
...
| Bonds / cash-like | 0 | 1.31 | 20 | -18.69 |
