...
## Period
- Report type: weekly
- Period start: 2026-06-12
- Period end: 2026-06-12
- Generated: 2026-06-12T17:22:23.766Z

## Decision View

### Executive Summary
Latest snapshot: CHF 151083.32148882 total and CHF 150000 cash. No in-flight execution states are currently pending. Dashboard freshness is current against the tracked source files. Broker readiness is degraded: Interactive Brokers connectivity is available, but broker-backed pricing is not yet yielding a usable live/delayed quote posture. Rendering required a fallback: render mode rendered Reporting delivery posture needs operator attention (1 pending item(s)).
...
- Portfolio value change since previous report: CHF 151083.32
...
| Metric | Value |
|---|---:|
| Start value CHF | 151083.32148882 |
| End value CHF | 151083.32148882 |
| Change CHF | 0 |
| Change % | 0 |
...
| Bonds / cash-like | 0 | 1.34 | 20 | -18.66 |
