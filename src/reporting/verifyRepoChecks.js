const checks = [
  ...
  ['test:portfolio-markdown-parsers', ['scripts/test-portfolio-markdown-parsers.js']],
  ['test:ai-assessment', ['scripts/test-ai-assessment.js']],
  ['test:dashboard-digest-rebalance-and-ai', ['scripts/test-dashboard-digest-rebalance-and-ai.js']],
  ...
  ['test:cancel-order-broker-only', ['scripts/test-cancel-order-broker-only.js']],
