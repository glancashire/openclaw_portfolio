...
## Summary
- Generated at: 2026-05-29T09:38:13.652Z
- Portfolios discovered: 2
- Active portfolios: 1
- Demo-like portfolios: 1
- Total value CHF: 93080.35
...
| etf | active | 93080.35432 | warning | 2 out_of_bounds | 0 | 8 | 2 | 0 | 0 | [contract_resolution_failed CH0032912732] Verify conid, symbol, exchange, and primary exchange before retrying. |
...
6. [approval/medium/pending_user_approval] etf: 8 proposed trade row(s) still need user approval. — Review the proposed trades and approve or reject them explicitly.
...
8. [delivery/medium/pending] etf: Dashboard/report freshness is stale relative to source state. — Review report delivery readiness and clear the pending action.
