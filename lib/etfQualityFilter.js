...
const ETF_METADATA = {
  ...
  UBSSLI: { isin: 'CH0032912732', name: 'UBS ETF SLI', replication: 'physical', terPct: 0.20, currency: 'CHF', exchange: 'EBS', index: 'SLI', fundSizeEurM: 2239 },
  ...
  SPYL: { isin: 'IE000XZSV718', name: 'SPDR S&P 500 UCITS ETF USD Unhedged (Acc)', replication: 'physical', terPct: 0.03, currency: 'EUR', exchange: 'IBIS2', index: 'S&P 500', fundSizeEurM: 1200 },
  UBSPX: { isin: 'IE00BD4TXW66', name: 'UBS Core S&P 500 UCITS ETF USD acc', replication: 'physical', terPct: 0.03, currency: 'EUR', exchange: 'IBIS', index: 'S&P 500', fundSizeEurM: 1460 },
