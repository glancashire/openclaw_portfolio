...
function seedPortfolio(repoRoot) {
  ...
  fs.writeFileSync(path.join(repoRoot, 'runtime', 'observability', 'event-log.jsonl'), [
    JSON.stringify({ at: '2026-05-23T07:00:00Z', kind: 'health_check', health: 'healthy', severity: 'low', blockerCount: 0 }),
    JSON.stringify({ at: '2026-05-23T08:00:00Z', kind: 'health_check', health: 'blocked', severity: 'high', blockerCount: 2 }),
  ].join('\n') + '\n');
